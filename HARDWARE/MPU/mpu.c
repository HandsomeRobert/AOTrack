...
void MPU_Memory_Protection(void)
{
	...
	MPU_Set_Protection(0XC0000000, MPU_REGION_SIZE_32MB, MPU_REGION_NUMBER2, MPU_REGION_FULL_ACCESS);	//保护整个外部SDRAM，打开访问权限。以免出现hardware fault, usage Fault: unaligned 
