...
//重定义——ttywrch函数 以解决Link错误 Library reports error: __use_no_semihosting was requested, but _ttywrch was referenced
_ttywrch(int ch)
{
	ch = ch;
}
...
//		__HAL_UART_DISABLE_IT(huart,UART_IT_TC);
		...
		HAL_NVIC_SetPriority(USART3_IRQn,7,0);			//抢占优先级2，子优先级3	
	}
